...
# Remove the big header, replace with a slim intro row
st.markdown("""
<div style='text-align:center; font-size:1.18rem; margin-bottom:0.7em; font-family:EB Garamond,serif; color:#694800;'>
    <b>QuantPilot</b>: Analytics, interactive charts, and easy-to-understand insights.<br>
    <span style='color:#7c6f5c; font-size:1.00rem;'>
    Clarity for your stocks—no matter your experience level.
    </span>
</div>
""", unsafe_allow_html=True)
